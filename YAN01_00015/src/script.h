...
MsgNode alice0 = { {"How do you know about Alice?",}, 1, {"I __read your communications.",}, 1, {&alice1,}, 1 };
...
MsgNode arm_transmit11 = { {"Okay. Here goes nothing. *Bob is __free. He is now sitting on your keboard and you see BAAAAAA... scrolling across the screen*",}, 1, {}, 0, {}, 0 };
...
MsgNode lights212211111 = { {"Doesn't seem like it to me.",}, 1, {"Well why don't you __read some lights to me.",}, 1, {&vulnerability,}, 1 };
...
MsgNode lights2122 = { {"Wait. These lights are not just arranged in a grid pattern. They also seem to be labeled.",}, 1, {"How so?","Can you __read some lights to me?",}, 2, {&lights21221,&vulnerability,}, 2 };
