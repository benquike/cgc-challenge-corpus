...
{
    size_t alloc_length = __strlen( instr ) + 1;
    m_pData = new char[alloc_length];

    __memcpy( (void *)m_pData, (void *)instr, alloc_length-1 );
...
String::String( const String &instr )
{
    ...
    __memcpy( m_pData, instr.m_pData, instr.m_length );
...
void String::operator=( const String &rhs )
{
    ...
    __memcpy( m_pData, rhs.m_pData, rhs.m_length );
...
void String::SetString( const char *pszBuffer )
{
    ...
    size_t alloc_length = __strlen( pszBuffer ) + 1;
    m_pData = new char[alloc_length];

    __memcpy( (void *)m_pData, (void *)pszBuffer, alloc_length-1 );
    m_pData[alloc_length-1] = '\0';
