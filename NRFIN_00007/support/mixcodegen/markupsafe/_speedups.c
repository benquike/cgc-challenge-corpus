...
#define UNICHR(x) (PyUnicode_AS_UNICODE((PyUnicodeObject*)PyUnicode_DecodeASCII(x, __strlen(x), NULL)));
...
init_constants(void)
{
	...
	__memset(escaped_chars_delta_len, 0, sizeof (escaped_chars_delta_len));
