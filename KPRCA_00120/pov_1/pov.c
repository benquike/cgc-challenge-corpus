...
{
  transmit_all(STDOUT, s, __libpov_strlen(s));
}
...
int main(void)
{
    ...
    for (size_t i = 0; i < 16; i++)
    {
      ...
      transmit_all(STDERR, "\nA\n", 3);
      delimited_read(STDIN, &buf, &bufsz, (unsigned char*)("Ticket Finished" EOL), __libpov_strlen("Ticket Finished" EOL));
      transmit_all(STDERR, "B\n", 2);
      delimited_read(STDIN, &buf, &bufsz, (unsigned char*)("OK" EOL), __libpov_strlen("OK" EOL));
